cask "libreoffice-cn" do
  ...
  url "https://mirrors.ustc.edu.cn/libreoffice/libreoffice/stable/#{version}/mac/#{arch}/LibreOffice_#{version}_MacOS_#{arch}.dmg",
      verified: "mirrors.ustc.edu.cn/libreoffice/libreoffice/stable/"
  name "LibreOffice"
  desc "Office suite"
