class AlistCli < Formula
  ...
  if OS.mac? && Hardware::CPU.arm?
    ...
    url "https://mirror.ghproxy.com/https://github.com/alist-org/alist/releases/download/v3.31.0/alist-darwin-amd64.tar.gz", verified: "mirror.ghproxy.com/"
    sha256 "b59f074bd5e5e81bcb5dfc057705adb9e8f0b43466f3df7a57210114e56c0920"
  elsif !OS.mac? && Hardware::CPU.arm?
