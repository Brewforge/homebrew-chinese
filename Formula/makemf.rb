class Makemf < Formula
  ...
  url "https://mirror.ghproxy.com/https://github.com/Mrered/Gobin/releases/download/v#{version}/makemf_#{version}_#{OS.mac? ? "darwin" : "linux"}_#{Hardware::CPU.arm? ? "arm64" : "amd64"}.tar.gz",
